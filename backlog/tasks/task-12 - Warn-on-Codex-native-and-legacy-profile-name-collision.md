...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 A colliding native account produces a Warn naming the alias and the winning source
- [x] #2 Non-colliding native accounts start unchanged
- [x] #3 The behaviour is documented in docs/WITH_USER_ENV.md
<!-- AC:END -->
